...
const blogIdeasLink = { href: "/admin/blog-ideas", label: "Blog Ideas", icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 2.5h10v11H3v-11Z" stroke="currentColor" strokeWidth="1.5" opacity=".75"/><path d="M5.5 5.5h5M5.5 8h5M5.5 10.5h3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity=".5"/></svg> };
...
export default function AdminSidebar({ isDev }: { isDev: boolean }) {
  ...
  const nav = [
    {
      section: "Content",
      links: isDev ? [dashboardLink, postsLink, blogIdeasLink, teamLink, partnersLink, seoLink] : [dashboardLink],
    },
    {
      section: "Orders",
      links: [ordersLink],
